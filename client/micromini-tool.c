...
struct subcommand subcommands[] =
{
  ...
  {.name = "set-ain-falling-threshold", .type = SUBCOMMAND_READ_REG, .arg_name = "falling-threshold",.write_opts = {.reg = MICROMINI_AIN_FALLING_THRESH },.doc = "Set falling threshold"},
  ...
  {.name = "get-ain-falling-threshold", .type = SUBCOMMAND_WRITE_REG,, .read_opts = {.reg = MICROMINI_AIN_FALLING_THRESH },.doc = "Get falling threshold"},
